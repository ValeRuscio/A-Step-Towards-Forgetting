...
def validate(s):
    ...
    for k in ['a_steps','b_steps','checkpoint_every','eval_batch','derivative_batch','microbatch','accumulation','text_train','text_valid','text_test','path_population','uniform_updates']:
